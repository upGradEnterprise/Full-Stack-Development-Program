package com.zeta.spring.scope.singleton;

import com.zeta.spring.scope.singleton.bean.Actor;
import com.zeta.spring.scope.singleton.bean.Bachchan;
import com.zeta.spring.scope.singleton.config.AppConfig;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

public class ScopeSingletonApp {
